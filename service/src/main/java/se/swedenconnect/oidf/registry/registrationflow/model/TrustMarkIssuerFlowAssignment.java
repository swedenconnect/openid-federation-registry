...
/**
 * Assignment entity linking a registration flow to a trust mark issuer.
 *
...
@NoArgsConstructor
@Entity
@Table(name = "tm_issuer_flow_assignment",
    uniqueConstraints = @UniqueConstraint(columnNames = {"trustmark_issuer_id", "flow_id"}))
public class TrustMarkIssuerFlowAssignment extends BaseEntity {
  ...
  @JoinColumn(name = "trustmark_issuer_id", nullable = false)
   ...
   * @param trustMarkIssuer the trust mark issuer
   * @param registrationFlow the flow to assign
   */
  public TrustMarkIssuerFlowAssignment(final UUID assignId, final TrustMarkIssuer trustMarkIssuer,
