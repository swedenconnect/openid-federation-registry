 ...
 */
@Data
@Schema(name = "TrustmarkRegistration")
public class TrustmarkRegistrationDto {
  ...
  @Schema(description = "Trustmarks with status", example = "")
  private List<TrustmarkStatusDto> trustmarkStatus;
