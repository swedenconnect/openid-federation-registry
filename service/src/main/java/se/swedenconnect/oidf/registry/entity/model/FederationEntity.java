 ...
 */
package se.swedenconnect.oidf.registry.entity.model;
...
public class FederationEntity extends BaseEntity {
  ...
  private se.swedenconnect.oidf.registry.organization.model.Organization organization;

  @OneToOne(mappedBy = "entity", cascade = CascadeType.REMOVE)
  private TrustAnchorIntermediateModule trustanchorIntermediate;
  ...
  public boolean hasModules() {
    if (this.entityType == EntityType.HOSTED_ENTITY) {
      return false;
    }
