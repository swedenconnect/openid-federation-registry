...
/**
 * The Instance class represents an instance in the system and maps to the "instance" table in the database. It
...
public class Instance extends BaseEntity {
  @Id
  @Column(name = "instance_id", columnDefinition = "char(36)", nullable = false)
   ...
   *
   * @param organization the {@code Organization} to be added to the instance's set of organizations.
   */
