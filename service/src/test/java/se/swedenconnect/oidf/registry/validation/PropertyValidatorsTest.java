...
public class PropertyValidatorsTest {
  ...
  private PropertyValidators.ValidationBuilder builder() {
    return this.propertyValidators.builder(VariableValueResolver.defaultResolver());
  }

  @Test
  public void testPolicyValidation_OK() {
    final String policy = """
        {
        "metadata_policy" : {
    ...
    final ValidationStatus vs = this.builder()
        .json().oidfPolicy()
        .build()
        .validate("policy", policy);

    assertEquals("json.oidfpolicy", vs.getValidationRule());
  }

  @Test
  public void testPolicyValidation_empty() {
  ...
  @Test
  public void testPolicyValidation_fail() {

    final String policy = """
        {
        "metadata_policy" : {
          "openid_relying_party": {
            "id_token_signed_response_alg": "fail"
          }
        }
        }
        """;

    final Optional<PropertyValidationFailException> ex = this.builder()
        .oidfPolicy()
        .build()
        .eval("policy", policy);
    assertTrue(ex.isPresent());
    assertEquals("policy.metadata_policy.openid_relying_party.id_token_signed_response_alg",
        ex.get().getFiledName());
  }

  @Test
  public void testResolveValidator_noValidators() {
    final PropertyValidator result = this.builder().build();
  ...
  public void testResolveValidator_lengthValidator() {
    final PropertyValidator result = this.builder().length(5, 10).build();
  ...
  public void testResolveValidator_jwksValidatorBuilder() {
    ...
    final PropertyValidator jwksValidator = this.builder().json().jwks().build();
  ...
  public void testResolveValidator_requiredValidator() {
    final PropertyValidator result = this.builder().required().build();
  ...
  public void testResolveValidator_emailValidator() {
    final PropertyValidator result = this.builder().email().build();
  ...
  public void testResolveValidator_endsWithValidator() {
    final PropertyValidator result = this.builder().endsWith("xyz").build();
  ...
  public void testResolveValidator_entityIdValidator() {
    final PropertyValidator result = this.builder().entityid().build();
    assertThrows(PropertyValidationFailException.class, () -> result.validate("key", "abc"));
  ...
  public void testResolveValidator_startsWithValidator() {
    final PropertyValidator result = this.builder().startsWith("http://www.digg.se").build();
  ...
  public void testResolveValidator_containsValidator() {
    final PropertyValidator result = this.builder().contains("abc").build();
  ...
  public void testResolveValidator_alphaValidator() {
    final PropertyValidator result = this.builder().alpha().build();
  ...
  public void testResolveValidator_alphanumericValidator() {
    final PropertyValidator result = this.builder().alphanumeric().build();
    assertThrows(PropertyValidationFailException.class, () -> result.validate("key", "abc$%"));
  ...
  public void testResolveValidator_numberValidator() {
    final PropertyValidator result = this.builder().number().build();
    assertThrows(PropertyValidationFailException.class, () -> result.validate("key", "abc"));
  ...
  public void testResolveValidator_dateValidator() {
    final PropertyValidator result = this.builder().date().build();
  ...
  public void testResolveValidator_betweenValidator() {
    final PropertyValidator result = this.builder().between(1, 10).build();
  ...
  public void testResolveValidator_urlValidator() {
    final PropertyValidator result = this.builder().url().build();
  ...
  public void testResolveValidator_matchesValidator() {
    final PropertyValidator result = this.builder().matches("^\\d{3}-\\d{2}-\\d{4}$").build();
  ...
  public void testResolveValidator_minValidator() {
    final PropertyValidator result = this.builder().min(5).build();
  ...
  public void testResolveValidator_maxValidator() {
    final PropertyValidator result = this.builder().max(10).build();
  ...
  public void testResolveValidator_jsonValidator_validJson() {
    final PropertyValidator result = this.builder().json().build();
  ...
  public void testResolveValidator_jwksValidator() {
    ...
    final PropertyValidator result = this.builder().jwks().build();
  ...
  public void testResolveValidator_jwksValidator_invalidJwk() {
    ...
    final PropertyValidator result = this.builder().jwk().build();
