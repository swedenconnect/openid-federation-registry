...
/**
 * Test configuration class for setting up Testcontainers for the application.
 * This configuration class should contain the necessary bean definitions
 * to initialize and configure Testcontainers for integration tests.
 *
