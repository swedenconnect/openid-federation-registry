 ...
 * <br>
 * Usage:<br>
 * - Can be used directly by annotating your test class with {@code @ExtendWith(MariaDBInitializer.class)}.
...
public class MariaDBInitializer implements BeforeAllCallback {
  ...
  /**
   * Loads the properties required for configuring the database connection and the Flyway migration tool.
   * These properties are retrieved from the {@code MariaDBContainer} instance managed by this class.
   */
