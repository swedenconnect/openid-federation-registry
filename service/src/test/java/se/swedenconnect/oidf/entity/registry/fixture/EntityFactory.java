...
public class EntityFactory {
  ...
  /**
   * URL representing the first subject in the system. This constant is used as a default subject when creating
   * entities.
   */
  ...
  /**
   * The default subject used for creating instances of {@link EntityRecord}. This constant is typically used when no
   * specific subject is provided.
   */
  ...
  /**
   * Creates an instance of {@link EntityRecord} with default values. Uses JwksSource by default and does not include a
   * Hosted object.
   *
  ...
  /**
   * Creates a default instance of {@link EntityRecord} with given subject. Uses a default JwksSource and predefined URL
   * and policy.
   *
  ...
  /**
   * Merges the data from the provided {@link EntityRecord} into an existing {@link EntityEntity} object. Updates the
   * issuer, subject, and entity fields of the {@link EntityEntity}. Sets the externalId of the {@link EntityEntity} if
   * it is null, using the entityRecordId from {@link EntityRecord}. Throws an exception in case of JSON processing
